part of permission_handler_web;

class PermissionHandlerPlugin extends PermissionHandlerPlatform {
  static void registerWith(Registrar registrar) {
    PermissionHandlerPlatform.instance = PermissionHandlerPlugin._();
  }

  PermissionHandlerPlugin._();
